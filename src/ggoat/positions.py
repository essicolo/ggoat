...
def position_dodge(width: Optional[float] = None, 
                   preserve: str = "total") -> Position:
    """
...
def position_dodge2(width: Optional[float] = None,
                    preserve: str = "total",
                    padding: float = 0.1,
                    reverse: bool = False) -> Position:
    """
...
def position_jitter(width: Optional[float] = None, 
                    ...
                    seed: Optional[int] = None) -> Position:
    """
    ...
    Args:
        width: Amount of vertical and horizontal jitter. The jitter is added 
