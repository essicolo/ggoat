...
class ggplot:
    ...
    def coord_fixed(self, ratio=1, xlim=None, ylim=None, expand=True, **kwargs):
        ...
        """
        new_plot = self._copy()
        coord = {'type': 'fixed', 'ratio': ratio, 'xlim': xlim, 'ylim': ylim, 'expand': expand}
        coord.update(kwargs)
    ...
    def coord_polar(self, theta='x', start=0, direction=1, **kwargs):
        ...
        """
        new_plot = self._copy()
        coord = {'type': 'polar', 'theta': theta, 'start': start, 'direction': direction}
        coord.update(kwargs)
        new_plot.coords = coord
        return new_plot

    def coord_map(self, projection='mercator', xlim=None, ylim=None, expand=True, **kwargs):
        """
        Map projection coordinate system.
        """
        new_plot = self._copy()
        coord = {'type': 'map', 'projection': projection, 'xlim': xlim, 'ylim': ylim, 'expand': expand}
        coord.update(kwargs)
        new_plot.coords = coord
        return new_plot
    ...
    def sampling_random_stratified(self, strata=None, n=None, **kwargs):
        ...
        if not hasattr(new_plot, 'sampling'):
            new_plot.sampling = []
        new_plot.sampling.append({'type': 'random_stratified', 'strata': strata, 'n': n, **kwargs})
        return new_plot
    ...
    def sampling_group_systematic(self, interval=None, **kwargs):
        ...
        if not hasattr(new_plot, 'sampling'):
            new_plot.sampling = []
        new_plot.sampling.append({'type': 'group_systematic', 'interval': interval, **kwargs})
        return new_plot
    ...
    def _copy(self):
        ...
        new_plot.theme = self.theme.copy() if hasattr(self.theme, 'copy') else self.theme
    ...
    def geom_lollipop(self,
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'lollipop', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot
    ...
    def geom_pie(self,
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'pie', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_dotplot(self,
                     mapping: Optional[aes] = None,
                     data: Optional[Any] = None,
                     stat: str = "identity",
                     position: str = "identity",
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'dotplot', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot
    ...
    def geom_bin2d(self,
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'bins': bins, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'bin2d', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot
    ...
    def geom_hex(self,
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'bins': bins, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'hex', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_raster(self,
                    mapping: Optional[aes] = None,
                    data: Optional[Any] = None,
                    stat: str = "identity",
                    position: str = "identity",
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'raster', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_crossbar(self,
                      mapping: Optional[aes] = None,
                      data: Optional[Any] = None,
                      stat: str = "identity",
                      position: str = "identity",
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'width': width, 'fatten': fatten, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'crossbar', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_linerange(self,
                       mapping: Optional[aes] = None,
                       data: Optional[Any] = None,
                       stat: str = "identity",
                       position: str = "identity",
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'linerange', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_pointrange(self,
                        mapping: Optional[aes] = None,
                        data: Optional[Any] = None,
                        stat: str = "identity",
                        position: str = "identity",
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'pointrange', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_contour(self,
                     mapping: Optional[aes] = None,
                     data: Optional[Any] = None,
                     stat: str = "contour",
                     position: str = "identity",
        ...
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, 'bins': bins, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'contour', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_contourf(self, mapping=None, data=None, stat="contourf", position="identity", fill=None, color=None, colour=None, bins=None, **kwargs):
        """Filled contours of a 3D surface in 2D."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'bins': bins, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'contourf', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_polygon(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Filled closed path defined by vertex coordinates."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'polygon', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_map(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Display polygons from a reference map."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'map', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_abline(self, mapping=None, data=None, stat="identity", position="identity", slope=None, intercept=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Add a straight line with specified slope and intercept."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'slope': slope, 'intercept': intercept, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'abline', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_hline(self, mapping=None, data=None, stat="identity", position="identity", yintercept=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Add a straight horizontal line."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'yintercept': yintercept, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'hline', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_vline(self, mapping=None, data=None, stat="identity", position="identity", xintercept=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Add a straight vertical line."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'xintercept': xintercept, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'vline', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_band(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Add a straight vertical or horizontal band."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'band', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_ribbon(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Display a y interval defined by ymin and ymax."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'ribbon', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_density2d(self, mapping=None, data=None, stat="density2d", position="identity", color=None, colour=None, size=None, **kwargs):
        """Display density function contour."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'density2d', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_density2df(self, mapping=None, data=None, stat="density2df", position="identity", fill=None, color=None, colour=None, **kwargs):
        """Fill density function contour."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'density2df', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_freqpoly(self, mapping=None, data=None, stat="identity", position="identity", color=None, colour=None, size=None, **kwargs):
        """Frequency polygon (line chart for counts)."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'freqpoly', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_step(self, mapping=None, data=None, stat="identity", position="identity", direction=None, color=None, colour=None, size=None, **kwargs):
        """Step plot (stairs)."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'direction': direction, 'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'step', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_rect(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Axis-aligned rectangle defined by two corners."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'rect', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_segment(self, mapping=None, data=None, stat="identity", position="identity", color=None, colour=None, linetype=None, size=None, **kwargs):
        """Draw a straight line segment between two points."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'segment', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_curve(self, mapping=None, data=None, stat="identity", position="identity", curvature=None, color=None, colour=None, linetype=None, size=None, **kwargs):
        """Draw a curved line."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'curvature': curvature, 'color': color, 'linetype': linetype, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'curve', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_spoke(self, mapping=None, data=None, stat="identity", position="identity", angle=None, radius=None, color=None, colour=None, size=None, **kwargs):
        """Draw a straight line segment with given length and angle from the starting point."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'angle': angle, 'radius': radius, 'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'spoke', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_text_repel(self, mapping=None, data=None, stat="identity", position="identity", color=None, colour=None, size=None, **kwargs):
        """Add repelling text labels that avoid overlapping."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'text_repel', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_label(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, size=None, **kwargs):
        """Add a text with a rectangle behind the text."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'label', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_label_repel(self, mapping=None, data=None, stat="identity", position="identity", fill=None, color=None, colour=None, size=None, **kwargs):
        """Add repelling text labels with background boxes."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'fill': fill, 'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'label_repel', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_qq(self, mapping=None, data=None, stat="qq", position="identity", color=None, colour=None, size=None, **kwargs):
        """Quantile-quantile plot."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'qq', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_qq2(self, mapping=None, data=None, stat="qq2", position="identity", color=None, colour=None, size=None, **kwargs):
        """Quantile-quantile plot (type 2)."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'qq2', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_qq_line(self, mapping=None, data=None, stat="qq_line", position="identity", color=None, colour=None, size=None, **kwargs):
        """Quantile-quantile fitting line."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'qq_line', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_qq2_line(self, mapping=None, data=None, stat="qq2_line", position="identity", color=None, colour=None, size=None, **kwargs):
        """Quantile-quantile fitting line (type 2)."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'qq2_line', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_function(self, mapping=None, data=None, stat="function", position="identity", color=None, colour=None, size=None, fun=None, **kwargs):
        """Compute and draw a function."""
        new_plot = self._copy()
        if color is None and colour is not None:
            color = colour
        params = {k: v for k, v in {'color': color, 'size': size, 'fun': fun, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'function', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_blank(self, mapping=None, data=None, stat="identity", position="identity", **kwargs):
        """Draw nothing (useful for scale expansion)."""
        new_plot = self._copy()
        params = {k: v for k, v in {**kwargs}.items() if v is not None}
        layer = {'geom_type': 'blank', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_imshow(self, mapping=None, data=None, stat="identity", position="identity", image=None, **kwargs):
        """Display image specified by ndarray with shape."""
        new_plot = self._copy()
        params = {k: v for k, v in {'image': image, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'imshow', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def geom_livemap(self, mapping=None, data=None, stat="identity", position="identity", location=None, zoom=None, **kwargs):
        """Display an interactive map."""
        new_plot = self._copy()
        params = {k: v for k, v in {'location': location, 'zoom': zoom, **kwargs}.items() if v is not None}
        layer = {'geom_type': 'livemap', 'mapping': mapping, 'data': data, 'stat': stat, 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def stat_sum(self, mapping=None, data=None, geom="bar", position="identity", **kwargs):
        """Sum unique values (stat_sum)."""
        new_plot = self._copy()
        layer = {'geom_type': geom, 'mapping': mapping, 'data': data, 'stat': 'sum', 'position': position, 'params': {**kwargs}}
        new_plot.layers.append(layer)
        return new_plot

    def stat_summary(self, mapping=None, data=None, geom="pointrange", position="identity", fun_data=None, fun_y=None, fun_ymin=None, fun_ymax=None, **kwargs):
        """Aggregated values of a single continuous variable grouped along x (stat_summary)."""
        new_plot = self._copy()
        params = {k: v for k, v in {'fun.data': fun_data, 'fun.y': fun_y, 'fun.ymin': fun_ymin, 'fun.ymax': fun_ymax, **kwargs}.items() if v is not None}
        layer = {'geom_type': geom, 'mapping': mapping, 'data': data, 'stat': 'summary', 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def stat_summary_bin(self, mapping=None, data=None, geom="pointrange", position="identity", bins=None, fun_data=None, fun_y=None, fun_ymin=None, fun_ymax=None, **kwargs):
        """Distribution by dividing x into bins and aggregating (stat_summary_bin)."""
        new_plot = self._copy()
        params = {k: v for k, v in {'bins': bins, 'fun.data': fun_data, 'fun.y': fun_y, 'fun.ymin': fun_ymin, 'fun.ymax': fun_ymax, **kwargs}.items() if v is not None}
        layer = {'geom_type': geom, 'mapping': mapping, 'data': data, 'stat': 'summary_bin', 'position': position, 'params': params}
        new_plot.layers.append(layer)
        return new_plot

    def stat_ecdf(self, mapping=None, data=None, geom="step", position="identity", **kwargs):
        """Empirical cumulative distribution function (stat_ecdf)."""
        new_plot = self._copy()
        layer = {'geom_type': geom, 'mapping': mapping, 'data': data, 'stat': 'ecdf', 'position': position, 'params': {**kwargs}}
        new_plot.layers.append(layer)
        return new_plot
    ...
    def arrow(self, angle=30, length=1, ends='last', type='open', **kwargs):
        ...
        return {'arrow': {'angle': angle, 'length': length, 'ends': ends, 'type': type, **kwargs}}
    ...
    def facet_grid(self, rows=None, cols=None, scales='fixed'): 
        ...
        new_plot = self._copy()
        new_plot.facet = {'type': 'grid', 'rows': rows, 'cols': cols, 'scales': scales}
        return new_plot

    def facet_wrap(self, facets=None, nrow=None, ncol=None, scales='fixed'):
        """Split data by one or more faceting variables (facet_wrap)."""
        new_plot = self._copy()
        new_plot.facet = {'type': 'wrap', 'facets': facets, 'nrow': nrow, 'ncol': ncol, 'scales': scales}
        return new_plot
    ...
    def facet_wrap(self, var: Union[str, List[str]], nrow: Optional[int] = None, ncol: Optional[int] = None, scales: str = 'fixed'):
        """
        Facet the plot by a single variable (wrap layout).

        Args:
            var: Variable name or list of variable names to facet by.
            nrow: Number of rows for layout.
            ncol: Number of columns for layout.
            scales: Scales mode ('fixed', 'free', 'free_x', 'free_y').

        Returns:
            New ggplot object with facets set.
        """
        new_plot = self._copy()
        # normalize var into list
    ...
    def facet_grid(self, rows: Optional[Union[str, List[str]]] = None, cols: Optional[Union[str, List[str]]] = None, scales: str = 'fixed'):
        """
        Facet the plot using a grid specification (rows x columns).

        Args:
            rows: Variable name or list of names for rows.
            cols: Variable name or list of names for columns.
            scales: Scales mode ('fixed', 'free', 'free_x', 'free_y').

        Returns:
            New ggplot object with grid facets set.
        """
        new_plot = self._copy()
        # normalize inputs
        row_vars = None
        col_vars = None
        if rows is not None:
            row_vars = [rows] if isinstance(rows, str) else list(rows)
        if cols is not None:
            col_vars = [cols] if isinstance(cols, str) else list(cols)
    ...
    def coord_cartesian(self, xlim: Optional[tuple] = None, ylim: Optional[tuple] = None, expand: bool = True):
        """
    ...
    def coord_flip(self, xlim: Optional[tuple] = None, ylim: Optional[tuple] = None, expand: bool = True):
        """
        Flip x and y axes.
    ...
    def scale_color_manual(self, values, name=None, breaks=None, labels=None, limits=None, guide=None, **kwargs):
        """
        ...
        new_plot = self._copy()
        scale = scale_color_manual(values, name=name, breaks=breaks, labels=labels, 
                                  limits=limits, guide=guide, **kwargs)
        new_plot.scales['color'] = scale
        return new_plot
    
    def scale_fill_manual(self, values, name=None, breaks=None, labels=None, limits=None, guide=None, **kwargs):
        """
        ...
        new_plot = self._copy()
        scale = scale_fill_manual(values, name=name, breaks=breaks, labels=labels,
                                 limits=limits, guide=guide, **kwargs)
        new_plot.scales['fill'] = scale
        return new_plot
    
    def scale_color_gradient(self, low='#132B43', high='#56B1F7', name=None, breaks=None, labels=None, limits=None, guide=None, **kwargs):
        """
        ...
        new_plot = self._copy()
        scale = scale_color_gradient(low=low, high=high, name=name, breaks=breaks, 
                                   labels=labels, limits=limits, guide=guide, **kwargs)
        new_plot.scales['color'] = scale
        return new_plot
    
    def scale_fill_gradient(self, low='#132B43', high='#56B1F7', name=None, breaks=None, labels=None, limits=None, guide=None, **kwargs):
        """
        ...
        new_plot = self._copy()
        scale = scale_fill_gradient(low=low, high=high, name=name, breaks=breaks,
                                   labels=labels, limits=limits, guide=guide, **kwargs)
        new_plot.scales['fill'] = scale
        return new_plot
        ...
        if hasattr(self.data, 'columns'):
            ...
            for col in self.data.columns:
                ...
                if pd.api.types.is_numeric_dtype(series):
                    ...
                    data_dict[col] = [float(x) if x != 'null' and not np.isnan(float(x)) else None 
                                     for x in values]
    ...
    def _prepare_layer_data(self, data: Any) -> Dict[str, List]:
        ...
        return self._prepare_data() if data is self.data else self._convert_dataframe(data)
    ...
    def _prepare_scales(self) -> List[Dict[str, Any]]:
        ...
        for aesthetic, scale in self.scales.items():
            ...
            for attr in ['name', 'breaks', 'labels', 'limits', 'transform', 'guide', 
                        'values', 'low', 'high']:
    ...
    def save(self, filename: str, width: int = 600, height: int = 400, format: str = 'html'):
        """
