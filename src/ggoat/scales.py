...
def scale_color_gradient2(low='#132B43', mid='#FFFFFF', high='#56B1F7', midpoint=0, **kwargs):
    return Scale('color', 'gradient2', low=low, mid=mid, high=high, midpoint=midpoint, **kwargs)
def scale_fill_gradient2(low='#132B43', mid='#FFFFFF', high='#56B1F7', midpoint=0, **kwargs):
    return Scale('fill', 'gradient2', low=low, mid=mid, high=high, midpoint=midpoint, **kwargs)
...
def scale_gradient2(aesthetic, low='#132B43', mid='#FFFFFF', high='#56B1F7', midpoint=0, **kwargs):
    return Scale(aesthetic, 'gradient2', low=low, mid=mid, high=high, midpoint=midpoint, **kwargs)
...
"""
Scale functions for customizing aesthetic mappings.
"""
...
def scale_color_manual(values: Union[List[str], Dict[str, str]], 
    ...
    """
    return ManualScale('color', values, name=name, breaks=breaks, labels=labels, 
                      limits=limits, guide=guide, **kwargs)


def scale_fill_manual(values: Union[List[str], Dict[str, str]], 
                     name: Optional[str] = None,
                     breaks: Optional[List] = None,
                     labels: Optional[List[str]] = None,
                     limits: Optional[List] = None,
    ...
    """
    return ManualScale('fill', values, name=name, breaks=breaks, labels=labels,
                      limits=limits, guide=guide, **kwargs)


def scale_color_gradient(low: str = '#132B43', high: str = '#56B1F7',
                        name: Optional[str] = None,
                        breaks: Optional[List] = None,
                        labels: Optional[List[str]] = None,
                        limits: Optional[List] = None,
    ...
    """
    return Scale('color', 'gradient', low=low, high=high, name=name, 
                breaks=breaks, labels=labels, limits=limits, guide=guide, **kwargs)


def scale_fill_gradient(low: str = '#132B43', high: str = '#56B1F7',
                       name: Optional[str] = None,
                       breaks: Optional[List] = None,
                       labels: Optional[List[str]] = None,
                       limits: Optional[List] = None,
    ...
    """
    return Scale('fill', 'gradient', low=low, high=high, name=name,
                breaks=breaks, labels=labels, limits=limits, guide=guide, **kwargs)
